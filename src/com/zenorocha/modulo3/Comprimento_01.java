 ...
 * 		d) Obter uma string com o comprimento em metros, centímetros e milímetros.
 * 		   (Formato do string gerado: “x metros, y centímetros e z milímetros”).
 ...
 * 		h) Subtrair dois comprimentos, gerando um novo objeto comprimento que é a
 * 		   subtração de a por b => chamada será Comprimento.subtrair(a,b)
 * 		i) Multiplicar o comprimento por um valor inteiro (resultado será o objeto
 * 		   comprimento atualizado) => chamada será x.multiplicar(i);
 * 		j) Dividir o comprimento por um valor inteiro => idem à multiplicação.
 * 		   Armazene as informações de um comprimento em três atributos inteiros distintos (metros, centímetros, milímetros).
