...
public class Trem extends Recurso {
    private Recurso[] recursosDoTrem;
	...
	public Recurso[] getRecursosDoTrem() {
		return recursosDoTrem;
	}
	
	public Recurso getRecursosDoTrem(int i) {
		return recursosDoTrem[i];
	}

	public void setRecursosDoTrem(Recurso[] recursosDoTrem) {
