...
public class FormConversorTemperatura extends javax.swing.JFrame {
    ...
    private void ConverterCelsiusParaFahrenheit() throws HeadlessException {
        ...
        try {
            ...
            //                 Integer.valueOf(txtCelcius.getText())))));
            if (celsius < 10) {
            ...
            txtCelsius.requestFocus();                                                                      //JOptionPane.INFORMATIO_MESSAGE
        }
    }
    ...
    private void initComponents() {
        ...
        distCombo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Metros->Milhas", "Metros->Jardas", "Milhas->Metros", "Milhas->Jardas", "Jardas->Metros", "Jardas->Milhas" }));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(distCombo, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(96, 96, 96))
        );
    ...
    private void distComboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_distComboActionPerformed
        ...
        int item = distCombo.getSelectedIndex();
        ...
        switch (item) {
            case 0:
                ...
                break;
            case 1:
                conversao = ConversorDistancia.converteMparaJarda(medida);
                strConversao = String.valueOf(conversao);
                resposta.setText(strConversao);
                break;
            case 2:
                ...
                break;
            case 3:
                conversao = ConversorDistancia.converteMilhaparaJarda(medida);
                strConversao = String.valueOf(conversao);
                resposta.setText(strConversao);
                break;
            case 4:
                conversao = ConversorDistancia.converteJardaparaMetro(medida);
                strConversao = String.valueOf(conversao);
                resposta.setText(strConversao);
                break;
            case 5:
                conversao = ConversorDistancia.converteJardaparaMilha(medida);
                strConversao = String.valueOf(conversao);
                resposta.setText(strConversao);
                break;
